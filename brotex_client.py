...
if __name__ == '__main__':
    ...
    # make sure we're running out of a brotex_client installation directory
    if not os.path.exists('.brotex_client.marker'):
        sys.stderr.write("current working directory {} does not appear to be a brotex_client installation directory\n".format(
                      os.getcwd()))
        sys.exit(1)
